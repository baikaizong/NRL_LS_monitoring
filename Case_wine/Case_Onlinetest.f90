...
subroutine scoreSigmaMOC(Prob,mProb,Sigmascore)
  use IMSL
  use constants
  implicit none 
  real mProb(cells)
  real Prob(factor,levels),Score(factor,levels)
  real ScoreLS(6,cells)
...
subroutine scoreSigmaLLC(Prob,mProb,Sigmascore)
  use IMSL
  use constants
  implicit none 
  real mProb(cells)
  real Prob(factor,levels),Score(2,factor,levels)
  real ScoreLS(18,cells)
  real Sigma(cells,cells),Sigmascore(cells,cells),Intermatrix(23,23)
  integer i,j,k,t
  real unitthree(3),Jdesignthree(2,3)
  ...
  call Sigmafun(mProb,Sigma)
    i=0
    i=i+1
    call Kron(Jdesignthree(1,:),unitthree,unitthree,ScoreLS(i,:))
    i=i+1
    call Kron(Jdesignthree(2,:),unitthree,unitthree,ScoreLS(i,:))
    i=i+1
    call Kron(unitthree,Jdesignthree(1,:),unitthree,ScoreLS(i,:))
    i=i+1
    call Kron(unitthree,Jdesignthree(2,:),unitthree,ScoreLS(i,:))
    i=i+1
    call Kron(unitthree,unitthree,Jdesignthree(1,:),ScoreLS(i,:))
    i=i+1
    call Kron(unitthree,unitthree,Jdesignthree(2,:),ScoreLS(i,:)) 
    i=i+1
    call Kron(Jdesignthree(1,:),Jdesignthree(1,:),unitthree,ScoreLS(i,:))
    i=i+1
    call Kron(Jdesignthree(1,:),Jdesignthree(2,:),unitthree,ScoreLS(i,:))
    i=i+1
    call Kron(Jdesignthree(2,:),Jdesignthree(1,:),unitthree,ScoreLS(i,:))            
    i=i+1
    call Kron(Jdesignthree(2,:),Jdesignthree(2,:),unitthree,ScoreLS(i,:))    
    i=i+1
    call Kron(Jdesignthree(1,:),unitthree,Jdesignthree(1,:),ScoreLS(i,:))     
    i=i+1
    call Kron(Jdesignthree(1,:),unitthree,Jdesignthree(2,:),ScoreLS(i,:))
    i=i+1
    call Kron(Jdesignthree(2,:),unitthree,Jdesignthree(1,:),ScoreLS(i,:))     
    i=i+1
    call Kron(Jdesignthree(2,:),unitthree,Jdesignthree(2,:),ScoreLS(i,:))
    i=i+1
    call Kron(unitthree,Jdesignthree(1,:),Jdesignthree(1,:),ScoreLS(i,:))     
    i=i+1
    call Kron(unitthree,Jdesignthree(1,:),Jdesignthree(2,:),ScoreLS(i,:))
    i=i+1
    call Kron(unitthree,Jdesignthree(2,:),Jdesignthree(1,:),ScoreLS(i,:))     
    i=i+1
    call Kron(unitthree,Jdesignthree(2,:),Jdesignthree(2,:),ScoreLS(i,:))
...
subroutine Onlinetest()
  ...
  implicit none
    ...
    real*8 TestMLSO,TestMOC,TestLLC
	 real threshhold(levels,factor)
    real sample(cells),sampleIC(cells),sample_ewma(cells)
    real mProb(cells)
    real Sigmascore(cells,cells),SigmascoreMOC(cells,cells),SigmascoreLLC(cells,cells)
   ...
   call scoreSigmaMOC(Prob,mProb,SigmascoreMOC)
   call scoreSigmaLLC(Prob,mProb,SigmascoreLLC)
   ...
   call msampleOC(threshhold,cellOC)
	...
	TestMOC=0.0
  TestLLC=0.0
	 open(unit=13, file="D:/Location-Scale-Ordinal/Fortran_locationscale/Case_wine/OnlinetestMLSO20200228.txt")
    open(unit=14, file="D:/Location-Scale-Ordinal/Fortran_locationscale/Case_wine/OnlinetestMOC20200228.txt")
    open(unit=15, file="D:/Location-Scale-Ordinal/Fortran_locationscale/Case_wine/OnlinetestLLC20200228.txt")
    do j = 1, ewma, 1 
      call sampleonline(cell,sample)
      sample_ewma=lamda*sample+co_lamda*sample_ewma
      call MLSOTest(mProb,sample_ewma,Sigmascore,TestMLSO)
      call MOCTest(mProb,sample_ewma,SigmascoreMOC,TestMOC)
      call LLCTest(mProb,sample_ewma,SigmascoreLLC,TestLLC)
	  write(13,*),TestMLSO
    write(14,*),TestMOC
	write(15,*),TestLLC
    end do 
