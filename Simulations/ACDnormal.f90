Module constants  
  ...
  real, parameter :: threshhold_a1=-0.7,threshhold_a2=1.0,threshhold_a3=1.8
...
program main
	...
	real shiftm,shifts
     ...
     open(10,file="D:/Location-Scale-Ordinal/Fortran_locationscale/UOCP/ACTnormal_201026-L1N100.txt")
...
subroutine nomICProb(Prob)
	...
	interval(1)=ANORDF(threshhold_a1)
	interval(2)=ANORDF(threshhold_a2)
	interval(3)=ANORDF(threshhold_a3)
