...
program main
  ...
  open(11,file="F:/Fortran_locationscale/TXT/Prob.txt")
  do i = 1, cells, 1
  read(11,*),mProb(i)   
  end do
  close(11)
  ...
  Limit=  2.380469 
  call nomuniICProb(Prob)
  call scoreSigma(Prob,mProb,Sigmascore)

  open(10,file="F:/Fortran_locationscale/TXT/LLCnomalOCcase_918-1331.txt")
...
implicit none
  ...
  print*,simuarl(i)
    ...
    arl=(sum(simuarl)+erre)/(simu-erre)  
